...
- `release-jars/26.2/ghost-slots-0.2.8-pvp-safe.jar`: current Minecraft 26.2 release. Supports hotbar, main inventory, and armor locks.
...
5. Copy `ghost-slots-0.2.8-pvp-safe.jar` from `release-jars/26.2/` into the profile's `mods` folder.
...
```text
build/libs/ghost-slots-0.2.8-pvp-safe.jar
```
